function renderProducts(){
	...
	if( $activeCatButton.hasClass('filter-all') ){
		...
		category_class = category_class_stripped_of_active_class.replace("filter", "product_category");
	...
	$('.products_archive_hero').attr('class','hero_container products_archive_hero relative-block');
	if( category_class != "all" ){
